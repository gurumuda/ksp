                                ...
                                <tbody>
                                    ...
                                    foreach ($jenis_tr as $tr) : ?>
                                        <tr>
                                            ...
                                            <td><?= $tr->nama_trx; ?></td>
                                            <td><?= $tr->jenis_trx; ?></td>
                                            <td><?= $tr->periode_trx; ?></td>
                                            <td><?= $tr->nominal_trx; ?></td>
                                            <td>
                                                <button data-id="<?= $tr->jenistransaksi_id; ?>" data-nama="<?= $tr->nama_trx; ?>" class="btn btn-xs btn-outline-warning btn-ubah-anggota"><i class="fas fa-edit"></i></button>
                                                <button data-id="<?= $tr->jenistransaksi_id; ?>" data-nama="<?= $tr->nama_trx; ?>" class="btn btn-xs btn-outline-danger btn-hapus-anggota"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
