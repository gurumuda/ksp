...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>Data Biaya Beban</h1>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item"><a href="#">Data</a></li>
                        <li class="breadcrumb-item active">Jenis Biaya Beban</li>
                    </ol>
                </div>
            </div>
        </div><!-- /.container-fluid -->
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Data Biaya Beban Koperasi</h3>
                                ...
                                <tbody>
                                    ...
                                    foreach ($beban as $bb) : ?>
                                        <tr>
                                            <td><?= $no++; ?></td>
                                            <td><?= $bb->nama_trx; ?></td>
                                            <td><?= tglIndo($bb->tanggal_trx); ?></td>
                                            <td><?= number_format($bb->nominal, 0, ',', '.'); ?></td>
                                            <td>
                                                <button data-id="<?= $bb->beban_id; ?>" data-nama="<?= $bb->nama_trx; ?>" class="btn btn-xs btn-outline-danger btn-hapus-beban"><i class="fas fa-trash"></i></button>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Biaya Beban</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <?= form_open('/tambah/beban'); ?>
            <div class="modal-body">
                <div class="form-group row mb-1">
                    <label for="nama_trx" class="col-sm-4 col-form-label">Nama Transaksi</label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" name="nama_trx" placeholder="Nama Transaksi">
                    </div>
                </div>
                <div class="form-group row mb-1">
                    <label for="nominal_trx" class="col-sm-4 col-form-label">Nominal Transaksi</label>
                    <div class="col-sm-8">
                        <input type="number" class="form-control" name="nominal_trx" placeholder="Nominal Transaksi">
                    </div>
                </div>
                <div class="form-group row mb-1">
                    <label for="tanggal_trx" class="col-sm-4 col-form-label">Tanggal Transaksi</label>
                    <div class="col-sm-8">
                        <input type="date" class="form-control" name="tanggal_trx" value="<?= date('Y-m-d'); ?>">
                    </div>
                </div>
            </div>
            <div class="modal-footer justify-content-between">
                <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
                <button type="submit" id="btn-tambah-beban" class="btn btn-primary">Simpan Data</button>
            </div>
            <?= form_close(); ?>
        </div>
        <!-- /.modal-content -->
